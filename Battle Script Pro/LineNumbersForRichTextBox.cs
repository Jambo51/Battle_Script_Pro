...
namespace LineNumbersControlForRichTextBox
{
    ...
    public class LineNumbersForRichText : Control
    {
        ...
        private const string DefaultLineNumbersFormat = "0000";
        ...
        private void UpdateVisibleLineNumberItems()
        {
            ...
            if ((RTParent != null) && (RTParent.Text != ""))
            {
                ...
                else
                {
                    ...
                    pLineNumbersFormat = string.Empty.PadRight(pLineNumbersShowAsHexadecimal ? split.Length.ToString("X4").Length : split.Length.ToString().Length, '0');
                }
                CalculateAutoSizing();
            }
        }
